...
def main():
    ...
    Обрабатывает аргументы командной строки и запускает приложение.
    """
    # Простой парсинг аргументов командной строки (без использования argparse)
    vfs_path, script_path = None, None

    # Обрабатываем аргументы вручную
    i = 1
    ...
    root.mainloop()  # Главный цикл обработки событий GUI
